public class StringTest{
	public static void main(String[] args){
		...
		System.out.println("文字列s4は"+s4);
		if(s4.contains("Java")){
			System.out.println("文字列s4はJavaを含んでいます");
		}
		if(s4.endsWith("Java")){
			System.out.println("文字列s4は末尾にJavaがあります");
		}
		...
		System.out.println("文字列s5は"+s5);
		System.out.println("文字列s５の4文字目以降は"+s5.substring(3));
		System.out.println("文字列s５の4~8文字目は"+s5.substring(3,8));

		System.out.println("s5を全部小文字にすると"+s5.toLowerCase());
		System.out.println("s5を全部大文字にすると"+s5.toUpperCase());

		String s6="  Java lesson   ";
		System.out.println("文字列s6は"+s6);
